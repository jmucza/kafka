...
namespace Kafka.Client.IntegrationTests.ZooKeeperIntegration
{
    ...
    public class ZkBrokerPartitionInfoTests : IntegrationFixtureBase
    {
        ...
        public void WhenNewTopicIsAddedBrokerTopicsListenerCreatesNewMapping()
        {
            ...
            string topicPath = ZooKeeperClient.DefaultBrokerTopicsPath + "/" + this.CurrentTestTopic;
            ...
            Assert.IsTrue(mappings.ContainsKey(this.CurrentTestTopic));
        }
        ...
        public void WhenNewBrokerInTopicIsAddedBrokerTopicsListenerUpdatesMappings()
        {
            ...
            Assert.IsTrue(brokers.ContainsKey(2345));
            Assert.IsTrue(mappings.Keys.Contains(this.CurrentTestTopic));
            Assert.AreEqual(5, mappings[this.CurrentTestTopic].Count);
        }
