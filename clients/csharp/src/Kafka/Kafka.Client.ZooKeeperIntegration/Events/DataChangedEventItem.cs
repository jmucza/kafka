...
namespace Kafka.Client.ZooKeeperIntegration.Events
{
    ...
    public class DataChangedEventItem
    {
        ...
        /// </summary>
        public event ZooKeeperEventHandler<ZooKeeperDataChangedEventArgs> DataChanged
        {
            add
            {
        ...
        /// </summary>
        public event ZooKeeperEventHandler<ZooKeeperDataChangedEventArgs> DataDeleted
        {
            add
            {
